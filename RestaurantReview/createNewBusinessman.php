...
//Get values from sign up form or default values to 1
...
if ($password == $confirmPassword) {
    $qryCreate = "INSERT INTO businessman (Username, email, password) VALUES ('" . $Username . "', '" . $email . "', '" . $password . "')";
} else {
    echo "The entered passwords do not match.";
}

$qryFindUsername = "SELECT * FROM businessman ";
$qryFindUsername .= "WHERE Username = '" . $Username . "'";

$qryFindEmail = "SELECT * FROM businessman ";
