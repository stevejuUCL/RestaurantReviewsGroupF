...
<div>
    ...
    <div class="welcome" style=" background-color: orange;">
        <div class="container">
            <h2 style="margin-top: 20px;">Businessmen rating page: </h2>
            <div class="user_info" style="min-height: 500px; width:80%; margin: auto;margin-top: -60px">

                <form method="post" action="businessman_rating.php">
                            ...
                            <h5>
                                <div class="centered">
                                    <div class="form-group has-warning has-feedback" style="width: 100%; margin: auto;">
                                        <span>Message to businessman</span>:<textarea name = "review" class="form-control" rows="4" cols="70"></textarea>
                                    </div>
                                </div>
                            </h5>
                            <h5>
    ...
    if($_POST)
    {
        ...
        $sql = "INSERT INTO businessman_review (name, date_time, party_number,  review,  add_comments, rating) VALUE ('$name', '$date_time', '$party_number', '$review', '$add_comments', '$rating')";
